...
//				ss.searchSeat();
	...
	public static void memberMenu(String memberId) throws RecordNotFoundException {
		...
		Book1 ss1 = new Book1(cusName, stGubun, stNum, infoNum, seats, gradeList);
		Book2 ss2 = new Book2(cusName, stGubun, stNum, infoNum, seats, gradeList);
		Book3 ss3 = new Book3(cusName, stGubun, stNum, infoNum, seats, gradeList);
		Book4 ss4 = new Book4(cusName, stGubun, stNum, infoNum, seats, gradeList);
		Book5 ss5 = new Book5(cusName, stGubun, stNum, infoNum, seats, gradeList);
		...
		while(true) {
			...
			case 4:
				...
				case 1:
					...
					String name = inputString();
					if(ss1.cancel(name)) {
						System.out.println("예약을 취소되었습니다.");
					} else {
	...
	public static class Book1{
		...
		public Book1(String cusName, int stGubun, int stNum, int infoNum, String[][] seats, String[] gradeList) {
...
//			this.gradeList = gradeList;
	...
	public static class Book2{
		...
		public Book2(String cusName, int stGubun, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGubun = stGubun;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	public static class Book3{
		...
		public Book3(String cusName, int stGubun, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGubun = stGubun;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	public static class Book4{
		...
		public Book4(String cusName, int stGubun, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGubun = stGubun;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	public static class Book5{
		...
		public Book5(String cusName, int stGubun, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGubun = stGubun;
			this.stNum = stNum;
			this.infoNum = infoNum;
