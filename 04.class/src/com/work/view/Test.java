...
//		System.out.println(dto1.printInfo());
	...
	public static void main1(String[] args) {
		StudentScore dto = new StudentScore(); //객체생성 [modeifers] 클래스이름 참조변수명 = new 클래스명();
		// 생성한 객체의 여러분의 정보 변경
		dto.studentNo = "210517";
		dto.name = "유준성";
		dto.score = 99;
		
		// 생성한 객체의 정보(학번, 이름, 성적) 출력
		System.out.println("학번 : " + dto.studentNo);
		System.out.println("이름 : " + dto.name);
		System.out.println("성적 : " + dto.score);
