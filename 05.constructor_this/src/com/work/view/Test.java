...
public class Test {
	...
	public static void main3(String[] args) {
		StudentScore dto3 = new StudentScore("2번", "강감찬", 88);
		dto3.printInfo();
	}	
 ...
 */
	public static void main(String[] args) {
		...
		System.out.println("\n### 등록");
		service.addStudentScore("1번", "홍길동", 92); // null =>  배열 객체 접근 불가 => NullPointerException 예외발생 강제종료
...
//		service.students = null; // 기존 학생들의 성적정보가 저장된 배열객체가 메모리에서 사라짐 => 학생들의 성적정보 유실(엄청난문제)
...
//		service.count = 500; 
		...
		System.out.println("\n### 전체 학생 성적 조회 : ");
		service.printStudentScore(); // null =>  배열 객체 접근 불가 => NullPointerException 예외발생 강제종료
