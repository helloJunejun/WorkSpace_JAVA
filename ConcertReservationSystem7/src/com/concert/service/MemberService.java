...
public class MemberService {
	...
	public static void getMember2() {
		for(int index = 0; index < list.size();index++) {
			System.out.println("[" + (index + 1) + "번]" + list.get(index));
		}
	}
...
//				ss.searchSeat();
	...
	public static void memberMenu(String memberId) throws RecordNotFoundException {
		...
		Book1 ss1 = new Book1(cusName, stGrade, stNum, infoNum, seats, gradeList);
		Book2 ss2 = new Book2(cusName, stGrade, stNum, infoNum, seats, gradeList);
		Book3 ss3 = new Book3(cusName, stGrade, stNum, infoNum, seats, gradeList);
		Book4 ss4 = new Book4(cusName, stGrade, stNum, infoNum, seats, gradeList);
		Book5 ss5 = new Book5(cusName, stGrade, stNum, infoNum, seats, gradeList);
	...
	public static class Book1{
		...
		static String[] gradeList = {"VIP","S","R"};
		
		public Book1(String cusName, int stGrade, int stNum, int infoNum, String[][] seats, String[] gradeList) {
...
//			this.gradeList = gradeList;
	...
	while(true) {
		...
		int stNum = inputNumber()-1;
     		...
     		if(seats[stGrade][stNum].equals(cusName)){
     	...
     	for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book1.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
                System.out.print(" "+ Book1.seats[i][j]);
            }
     	}  
     	break;
	}
	...
	public void searchSeat() { // 좌석조회 및 출력
		...
		System.out.println(service.infoList.get(0));
		System.out.print("-------------------------");
		for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book1.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
	...
	public static class Book2{
		...
		public Book2(String cusName, int stGrade, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGrade = stGrade;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	while(true) {
		...
		int stNum = inputNumber()-1;
     	...
     	for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book2.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
                System.out.print(" "+ Book2.seats[i][j]);
            }
     	}  
     	break;
	}
	...
	public void searchSeat() { // 좌석조회 및 출력
		...
		System.out.println();
		System.out.println("-------공연 좌석 조회-------");
		System.out.println(service.infoList.get(1));
		System.out.print("-------------------------");
		for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book2.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
	...
	public static class Book3{
		...
		public Book3(String cusName, int stGrade, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGrade = stGrade;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	while(true) {
		...
		int stNum = inputNumber()-1;
     	...
     	for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book3.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
                System.out.print(" "+ Book3.seats[i][j]);
            }
     	}  
     	break;
	}
	...
	public void searchSeat() { // 좌석조회 및 출력
		...
		System.out.println();
		System.out.println("-------공연 좌석 조회-------");
		System.out.println(service.infoList.get(2));
		System.out.print("-------------------------");
		for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book3.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
	...
	public static class Book4{
		...
		public Book4(String cusName, int stGrade, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGrade = stGrade;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	while(true) {
		...
		int stNum = inputNumber()-1;
     	...
     	for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book4.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
                System.out.print(" "+ Book4.seats[i][j]);
            }
     	}  
     	break;
	}
	...
	public void searchSeat() { // 좌석조회 및 출력
		...
		System.out.println();
		System.out.println("-------공연 좌석 조회-------");
		System.out.println(service.infoList.get(3));
		System.out.print("-------------------------");
		for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book4.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
	...
	public static class Book5{
		...
		public Book5(String cusName, int stGrade, int stNum, int infoNum, String[][] seats, String[] gradeList) {
			this.cusName = cusName;
			this.stGrade = stGrade;
			this.stNum = stNum;
			this.infoNum = infoNum;
...
//			this.gradeList = gradeList;
	...
	while(true) {
		...
		int stNum = inputNumber()-1;
     	...
     	for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book5.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
                System.out.print(" "+ Book5.seats[i][j]);
            }
     	}  
     	break;
	}
	...
	public void searchSeat() { // 좌석조회 및 출력
		...
		System.out.println();
		System.out.println("-------공연 좌석 조회-------");
		System.out.println(service.infoList.get(4));
		System.out.print("-------------------------");
		for (int i = 0; i < 3; i++) {
            System.out.print("\n" + Book5.gradeList[i] + "석 ");
            for (int j = 0; j < 10; j++) {
