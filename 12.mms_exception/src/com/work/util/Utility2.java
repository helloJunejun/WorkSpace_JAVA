 ...
 * 모든 메서드는 객체 생성없이 사용가능한 클래스메서드(static 메서드)
 * </pre>
 * 
 * @author 임경혜
 *
...
//		System.out.println("현재날짜");
        ...
        stringBuffer.replace(2, 11, "*");
        System.out.println("After Replace :- " + stringBuffer);
		
        String password = "1234854678";
...
//	public static void getMemberPw(String str) {
//		StringBuffer stringBuffer = new StringBuffer("Hello World");
//        System.out.println("String :- " + stringBuffer);
//        
...
//        	
//        }
//        for(int index = 0; str.length();index++)
//        stringBuffer.replace(2, index, "*");
//        System.out.println("After Replace :- " + stringBuffer);
//			
//		return null;
//	}
...
//		return secureString.toString();
	...
	public static String getSecureAlphabetString(int length) {
		...
		for(int index = 0; index < length; index++) {
			secureString.append((char)(random.nextInt(26) + 65));
		}
		return secureString.toString();
	}
